...
#from datetime import get_name, get_unique, get_missing, get_weekend, get_weekday, get_future, get_empty_1900, get_empty_1970, get_min, get_max, get_barchart, get_frequent
...
class Test_datetime_name(unittest.TestCase):
    def setup(self):
        self.differentformatdata = pd.Series(['2021-12-27','2021-02-26', '2021-02-21'])
        self.differentformatdata1 = pd.Series(['27-12-2021','26-12-2021', '21-12-2021'])
    ...
    def test_name(self):
        columnname = "nametest"
        dc = DateColumn()
        result = dc.get_name(columnname)
        self.assertEqual(result, self.strname)

    def test_nameempty(self):
        nameempty = ""
        dc = DateColumn()
        result = dc.get_name(nameempty)
        self.assertEqual(result, "unknown")

    def test_namenone(self):
        namenone = None
        dc = DateColumn()
        result = dc.get_name(namenone)
        self.assertEqual(result, "unknown")

    def test_nameint(self):
        numname = 1
        dc = DateColumn()
        result = dc.get_name(numname)
